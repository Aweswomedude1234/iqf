...
export default function OurCause() {
  ...
  return (
    <div className="min-h-screen" data-testid="our-cause-page">
      {/* Hero Section */}
      <section className="bg-background py-20" data-testid="cause-hero-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center">
            <h1 className="text-5xl md:text-6xl font-bold text-foreground mb-8" data-testid="text-cause-hero-title">
              Our Cause
            </h1>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto" data-testid="text-cause-hero-subtitle">
      ...
      {/* Missions Grid */}
      <section className="bg-secondary py-20" data-testid="cause-grid-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {missions.map((mission, index) => {
              ...
              return (
                <AnimatedSection key={index} animationType="fade-in">
                  <div className="text-center bg-background rounded-xl p-8 hover-lift" data-testid={`cause-card-${index}`}>
                    ...
                    <h3 
                      ...
                      data-testid={`text-cause-title-${index}`}
                    >
                      {mission.title}
                    </h3>
                    <p 
                      className="text-muted-foreground leading-relaxed"
                      data-testid={`text-cause-description-${index}`}
                    >
                      {mission.description}
                    </p>
                  </div>
      ...
      <section className="bg-background py-20" data-testid="cause-how-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-16">
            <h2 className="text-4xl font-bold text-foreground mb-4" data-testid="text-how-title">
              How We Achieve Our Cause
            </h2>
